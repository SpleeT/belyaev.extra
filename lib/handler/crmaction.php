...
class CrmAction
{
  ...
  */
  ...
  const CARRIER_ID_USERFIELD = "UF_BELYAEV_EXTRA_CARRIER_ID";
  const DELIVERY_STATUS_USERFIELD = "UF_BELYAEV_EXTRA_STATUS_DELIVERY";
  const COST_DELIVERY_USERFIELD = "UF_BELYAEV_EXTRA_COST_DELIVERY";
  const CARRIER_TITLE_USERFIELD = "UF_BELYAEV_EXTRA_CARRIER_TITLE";
  const SERVICE_TITLE_USERFIELD = "UF_BELYAEV_EXTRA_SERVICE_TITLE";
  /**
