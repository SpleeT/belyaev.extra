...
$MESS['BELYAEV_EXTRA.MODULE_NAME'] = 'Управление тарифами ExtraPost';
$MESS['BELYAEV_EXTRA.MODULE_DESC'] = 'Таб с выбором тарифов из ExtraPost';
$MESS['BELYAEV_EXTRA.PARTNER_NAME'] = 'Владимир Беляев';
$MESS['BELYAEV_EXTRA.PARTNER_URI'] = 'http://ip.ereton.ru';
/* Название пользовательских полей */
$MESS['BELYAEV_EXTRA.USERFIELD_WEIGHT_RU'] = 'Общий вес товаров (гр)';
$MESS['BELYAEV_EXTRA.USERFIELD_WEIGHT_EN'] = 'Total weight of products (gramms)';
$MESS['BELYAEV_EXTRA.USERFIELD_PREPAYMENT_SUM_RU'] = 'Сумма предоплаты';
...
$MESS['BELYAEV_EXTRA.USERFIELD_COST_DELIVERY_RU'] = 'Стоимость доставки';
$MESS['BELYAEV_EXTRA.USERFIELD_COST_DELIVERY_EN'] = 'Cost delivery';
$MESS['BELYAEV_EXTRA.USERFIELD_ID_CARRIER_RU'] = 'Идентификатор ПВЗ';
$MESS['BELYAEV_EXTRA.USERFIELD_ID_CARRIER_EN'] = 'Pickup Point ID';
